                  ...
                  <div class="tree-folder d-flex">
                      <div class="tree-sidebar">
                          ...
                          <div class="wrap-tree-button text-center mt-4 mb-3">  
	                          ...
	                          <a href="javascript:void(0)" class="btn btn-blue btn-w-100 d-inline-block" id="add-folder">Add Folder<i class="fas fa-cloud-upload-alt"></i></a>	                          
                          </div>
                          ...
                          <div class="wrap-tree-button text-center mt-4 mb-3">  
                          	  <!-- Removed href="#" to avoild scrolling top -->                         
	                          <a href="javascript:void(0)" class="btn btn-blue btn-w-100 d-inline-block" id="add-files">File Upload <i class="fas fa-cloud-upload-alt"></i></a>
                          </div>
