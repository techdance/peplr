                                            ...
                                            <div class="box-middle">
                                                <div class="row row-custom">
	                                                ...
	                                                <div class="col-md-6">
	                                                    ...
	                                                    <aui:input type="text" name="certificate" label="Certificate" value="Curriculum Development Certification" cssClass="input" />
	                                                	<aui:input type="text" name="certificate" label="Certificate" value="" cssClass="input" />
	                                                	<aui:input type="text" name="certificate" label="Certificate" value="" cssClass="input" />
	                                                </div>
	                                            </div>
                                            </div>
