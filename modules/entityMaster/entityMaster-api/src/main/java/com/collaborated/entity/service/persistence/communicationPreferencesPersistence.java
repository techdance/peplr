...
/**
 * The persistence interface for the communication preferences service.
 *
 * <p>
 ...
 * @see communicationPreferencesUtil
 * @generated
 */
@ProviderType
public interface communicationPreferencesPersistence extends BasePersistence<communicationPreferences> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link communicationPreferencesUtil} to access the communication preferences persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(
		java.util.List<communicationPreferences> communicationPreferenceses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, communicationPreferences> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<communicationPreferences> findAll();
	...
	*/
	public java.util.List<communicationPreferences> findAll(int start, int end);
	...
	*/
	public java.util.List<communicationPreferences> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<communicationPreferences> orderByComparator);
