...
/**
 * Provides the local service interface for userInstitutionProfileSubDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see userInstitutionProfileSubDetailsLocalServiceUtil
...
public interface userInstitutionProfileSubDetailsLocalService
	extends BaseLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link userInstitutionProfileSubDetailsLocalServiceUtil} to access the user institution profile sub details local service. Add custom service methods to {@link com.collaborated.entity.service.impl.userInstitutionProfileSubDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
