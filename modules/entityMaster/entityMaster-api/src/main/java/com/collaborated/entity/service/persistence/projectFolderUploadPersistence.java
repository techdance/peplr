...
/**
 * The persistence interface for the project folder upload service.
 *
 * <p>
 ...
 * @see projectFolderUploadUtil
 * @generated
 */
@ProviderType
public interface projectFolderUploadPersistence extends BasePersistence<projectFolderUpload> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link projectFolderUploadUtil} to access the project folder upload persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(
		java.util.List<projectFolderUpload> projectFolderUploads);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, projectFolderUpload> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<projectFolderUpload> findAll();
	...
	*/
	public java.util.List<projectFolderUpload> findAll(int start, int end);
	...
	*/
	public java.util.List<projectFolderUpload> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<projectFolderUpload> orderByComparator);
