...
/**
 * Provides the local service interface for Custom_Workflow_Task. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see Custom_Workflow_TaskLocalServiceUtil
...
public interface Custom_Workflow_TaskLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Custom_Workflow_TaskLocalServiceUtil} to access the custom_ workflow_ task local service. Add custom service methods to {@link com.collaborated.entity.service.impl.Custom_Workflow_TaskLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Custom_Workflow_Task deleteCustom_Workflow_Task(
		java.lang.String workFlowTaskId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Custom_Workflow_Task fetchCustom_Workflow_Task(
		java.lang.String workFlowTaskId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Custom_Workflow_Task getCustom_Workflow_Task(
		java.lang.String workFlowTaskId) throws PortalException;
