...
/**
 * Provides the local service utility for labDetailedCourseTopics. This utility wraps
 * {@link com.collaborated.entity.service.impl.labDetailedCourseTopicsLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class labDetailedCourseTopicsLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.collaborated.entity.service.impl.labDetailedCourseTopicsLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.collaborated.entity.model.labDetailedCourseTopics addlabDetailedCourseTopics(
		com.collaborated.entity.model.labDetailedCourseTopics labDetailedCourseTopics) {
		return getService().addlabDetailedCourseTopics(labDetailedCourseTopics);
	}
	...
	*/
	public static com.collaborated.entity.model.labDetailedCourseTopics createlabDetailedCourseTopics(
		long PK_courseTopicsId) {
		return getService().createlabDetailedCourseTopics(PK_courseTopicsId);
	}
	...
	*/
	public static com.collaborated.entity.model.labDetailedCourseTopics deletelabDetailedCourseTopics(
		com.collaborated.entity.model.labDetailedCourseTopics labDetailedCourseTopics) {
		return getService()
				   .deletelabDetailedCourseTopics(labDetailedCourseTopics);
	}
	...
	*/
	public static com.collaborated.entity.model.labDetailedCourseTopics deletelabDetailedCourseTopics(
		...
		return getService().deletelabDetailedCourseTopics(PK_courseTopicsId);
	}

	public static com.collaborated.entity.model.labDetailedCourseTopics fetchlabDetailedCourseTopics(
		long PK_courseTopicsId) {
		return getService().fetchlabDetailedCourseTopics(PK_courseTopicsId);
	}
	...
	* @throws PortalException if a lab detailed course topics with the primary key could not be found
	*/
	public static com.collaborated.entity.model.labDetailedCourseTopics getlabDetailedCourseTopics(
		long PK_courseTopicsId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getlabDetailedCourseTopics(PK_courseTopicsId);
	}
	...
	*/
	public static com.collaborated.entity.model.labDetailedCourseTopics updatelabDetailedCourseTopics(
		com.collaborated.entity.model.labDetailedCourseTopics labDetailedCourseTopics) {
		return getService()
				   .updatelabDetailedCourseTopics(labDetailedCourseTopics);
	}
	...
	*/
	public static int getlabDetailedCourseTopicsesCount() {
		return getService().getlabDetailedCourseTopicsesCount();
	}
	...
	*/
	public static java.util.List<com.collaborated.entity.model.labDetailedCourseTopics> getlabDetailedCourseTopicses(
		int start, int end) {
		return getService().getlabDetailedCourseTopicses(start, end);
	}
	...
	*/
	...
	public static labDetailedCourseTopicsLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<labDetailedCourseTopicsLocalService, labDetailedCourseTopicsLocalService> _serviceTracker =
		ServiceTrackerFactory.open(labDetailedCourseTopicsLocalService.class);
}