...
/**
 * Provides the local service interface for languagePreferences. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see languagePreferencesLocalServiceUtil
...
public interface languagePreferencesLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link languagePreferencesLocalServiceUtil} to access the language preferences local service. Add custom service methods to {@link com.collaborated.entity.service.impl.languagePreferencesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
