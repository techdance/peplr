...
/**
 * Provides the local service interface for communicationPreferences. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see communicationPreferencesLocalServiceUtil
...
public interface communicationPreferencesLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link communicationPreferencesLocalServiceUtil} to access the communication preferences local service. Add custom service methods to {@link com.collaborated.entity.service.impl.communicationPreferencesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
