...
/**
 * The persistence utility for the custom_ calendar invitees service. This utility wraps {@link com.collaborated.entity.service.persistence.impl.Custom_CalendarInviteesPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see com.collaborated.entity.service.persistence.impl.Custom_CalendarInviteesPersistenceImpl
 * @generated
 */
@ProviderType
public class Custom_CalendarInviteesUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public static void clearCache(
		...
		getPersistence().clearCache(custom_CalendarInvitees);
	}
	 ...
	 */
	public static List<Custom_CalendarInvitees> findWithDynamicQuery(
	 ...
	 */
	public static Custom_CalendarInvitees update(
		Custom_CalendarInvitees custom_CalendarInvitees) {
		return getPersistence().update(custom_CalendarInvitees);
	}
	...
	public static Custom_CalendarInvitees update(
		...
		return getPersistence().update(custom_CalendarInvitees, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		Custom_CalendarInvitees custom_CalendarInvitees) {
		getPersistence().cacheResult(custom_CalendarInvitees);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(custom_CalendarInviteeses);
	}
	...
	*/
	public static Custom_CalendarInvitees create(long PK_calendarEventSubId) {
		return getPersistence().create(PK_calendarEventSubId);
	}
	...
	*/
	public static Custom_CalendarInvitees remove(long PK_calendarEventSubId)
		throws com.collaborated.entity.exception.NoSuchCustom_CalendarInviteesException {
		return getPersistence().remove(PK_calendarEventSubId);
	}

	public static Custom_CalendarInvitees updateImpl(
		Custom_CalendarInvitees custom_CalendarInvitees) {
		return getPersistence().updateImpl(custom_CalendarInvitees);
	}
	...
	* @throws NoSuchCustom_CalendarInviteesException if a custom_ calendar invitees with the primary key could not be found
	*/
	public static Custom_CalendarInvitees findByPrimaryKey(
		long PK_calendarEventSubId)
		throws com.collaborated.entity.exception.NoSuchCustom_CalendarInviteesException {
		return getPersistence().findByPrimaryKey(PK_calendarEventSubId);
	}
	...
	*/
	public static Custom_CalendarInvitees fetchByPrimaryKey(
		long PK_calendarEventSubId) {
		return getPersistence().fetchByPrimaryKey(PK_calendarEventSubId);
	}

	public static java.util.Map<java.io.Serializable, Custom_CalendarInvitees> fetchByPrimaryKeys(
	...
	*/
	public static List<Custom_CalendarInvitees> findAll() {
	...
	*/
	public static List<Custom_CalendarInvitees> findAll(int start, int end) {
	...
	*/
	...
	public static Custom_CalendarInviteesPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<Custom_CalendarInviteesPersistence, Custom_CalendarInviteesPersistence> _serviceTracker =
		ServiceTrackerFactory.open(Custom_CalendarInviteesPersistence.class);
}