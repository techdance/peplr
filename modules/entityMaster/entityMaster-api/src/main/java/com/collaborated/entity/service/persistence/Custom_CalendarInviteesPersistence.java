...
/**
 * The persistence interface for the custom_ calendar invitees service.
 *
 * <p>
 ...
 * @see Custom_CalendarInviteesUtil
 * @generated
 */
@ProviderType
public interface Custom_CalendarInviteesPersistence extends BasePersistence<Custom_CalendarInvitees> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Custom_CalendarInviteesUtil} to access the custom_ calendar invitees persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(
		java.util.List<Custom_CalendarInvitees> custom_CalendarInviteeses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, Custom_CalendarInvitees> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<Custom_CalendarInvitees> findAll();
	...
	*/
	public java.util.List<Custom_CalendarInvitees> findAll(int start, int end);
	...
	*/
	public java.util.List<Custom_CalendarInvitees> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Custom_CalendarInvitees> orderByComparator);
