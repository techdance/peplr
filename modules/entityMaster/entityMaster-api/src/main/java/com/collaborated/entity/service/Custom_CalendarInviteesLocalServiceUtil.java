...
/**
 * Provides the local service utility for Custom_CalendarInvitees. This utility wraps
 * {@link com.collaborated.entity.service.impl.Custom_CalendarInviteesLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class Custom_CalendarInviteesLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.collaborated.entity.service.impl.Custom_CalendarInviteesLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.collaborated.entity.model.Custom_CalendarInvitees addCustom_CalendarInvitees(
		com.collaborated.entity.model.Custom_CalendarInvitees custom_CalendarInvitees) {
		return getService().addCustom_CalendarInvitees(custom_CalendarInvitees);
	}
	...
	*/
	public static com.collaborated.entity.model.Custom_CalendarInvitees createCustom_CalendarInvitees(
		long PK_calendarEventSubId) {
		return getService().createCustom_CalendarInvitees(PK_calendarEventSubId);
	}
	...
	*/
	public static com.collaborated.entity.model.Custom_CalendarInvitees deleteCustom_CalendarInvitees(
		com.collaborated.entity.model.Custom_CalendarInvitees custom_CalendarInvitees) {
		return getService()
				   .deleteCustom_CalendarInvitees(custom_CalendarInvitees);
	}
	...
	*/
	public static com.collaborated.entity.model.Custom_CalendarInvitees deleteCustom_CalendarInvitees(
		...
		return getService().deleteCustom_CalendarInvitees(PK_calendarEventSubId);
	}

	public static com.collaborated.entity.model.Custom_CalendarInvitees fetchCustom_CalendarInvitees(
		long PK_calendarEventSubId) {
		return getService().fetchCustom_CalendarInvitees(PK_calendarEventSubId);
	}
	...
	* @throws PortalException if a custom_ calendar invitees with the primary key could not be found
	*/
	public static com.collaborated.entity.model.Custom_CalendarInvitees getCustom_CalendarInvitees(
		long PK_calendarEventSubId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getCustom_CalendarInvitees(PK_calendarEventSubId);
	}
	...
	*/
	public static com.collaborated.entity.model.Custom_CalendarInvitees updateCustom_CalendarInvitees(
		com.collaborated.entity.model.Custom_CalendarInvitees custom_CalendarInvitees) {
		return getService()
				   .updateCustom_CalendarInvitees(custom_CalendarInvitees);
	}
	...
	*/
	public static int getCustom_CalendarInviteesesCount() {
		return getService().getCustom_CalendarInviteesesCount();
	}
	...
	*/
	public static java.util.List<com.collaborated.entity.model.Custom_CalendarInvitees> getCustom_CalendarInviteeses(
		int start, int end) {
		return getService().getCustom_CalendarInviteeses(start, end);
	}
	...
	*/
	...
	public static Custom_CalendarInviteesLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<Custom_CalendarInviteesLocalService, Custom_CalendarInviteesLocalService> _serviceTracker =
		ServiceTrackerFactory.open(Custom_CalendarInviteesLocalService.class);
}