...
/**
 * The persistence interface for the user institution profile details service.
 *
 * <p>
 ...
 * @see userInstitutionProfileDetailsUtil
 * @generated
 */
@ProviderType
public interface userInstitutionProfileDetailsPersistence
	extends BasePersistence<userInstitutionProfileDetails> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link userInstitutionProfileDetailsUtil} to access the user institution profile details persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(
		java.util.List<userInstitutionProfileDetails> userInstitutionProfileDetailses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, userInstitutionProfileDetails> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<userInstitutionProfileDetails> findAll();
	...
	*/
	public java.util.List<userInstitutionProfileDetails> findAll(int start,
		int end);
	...
	*/
	public java.util.List<userInstitutionProfileDetails> findAll(int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<userInstitutionProfileDetails> orderByComparator);
