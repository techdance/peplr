...
import com.collaborated.entity.service.userCredentialLocalService;
...
/**
 * Provides the base implementation for the user credential local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.collaborated.entity.service.impl.userCredentialLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.collaborated.entity.service.impl.userCredentialLocalServiceImpl
 * @see com.collaborated.entity.service.userCredentialLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class userCredentialLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements userCredentialLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.collaborated.entity.service.userCredentialLocalServiceUtil} to access the user credential local service.
	 */
	 ...
	 */
	@Override
	public userCredential createuserCredential(long PK_userCredential) {
		return userCredentialPersistence.create(PK_userCredential);
	}
	...
	@Override
	public userCredential deleteuserCredential(long PK_userCredential)
		throws PortalException {
		return userCredentialPersistence.remove(PK_userCredential);
	}
	...
	public userCredential deleteuserCredential(userCredential userCredential) {
		return userCredentialPersistence.remove(userCredential);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(userCredential.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return userCredentialPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return userCredentialPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public userCredential fetchuserCredential(long PK_userCredential) {
		return userCredentialPersistence.fetchByPrimaryKey(PK_userCredential);
	}
	 ...
	 */
	@Override
	public userCredential getuserCredential(long PK_userCredential)
		throws PortalException {
		return userCredentialPersistence.findByPrimaryKey(PK_userCredential);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(userCredentialLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(userCredential.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("PK_userCredential");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(userCredentialLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(userCredential.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return userCredentialLocalService.deleteuserCredential((userCredential)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return userCredentialPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<userCredential> getuserCredentials(int start, int end) {
		return userCredentialPersistence.findAll(start, end);
	}
	...
	public int getuserCredentialsCount() {
		return userCredentialPersistence.countAll();
	}
	 ...
	 */
	public userCredentialLocalService getuserCredentialLocalService() {
	...
	public void setuserCredentialLocalService(
		userCredentialLocalService userCredentialLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.collaborated.entity.model.userCredential",
			userCredentialLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.collaborated.entity.model.userCredential");
	}
	...
	public String getOSGiServiceIdentifier() {
		return userCredentialLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = userCredentialPersistence.getDataSource();
	...
	@BeanReference(type = userCredentialLocalService.class)
	protected userCredentialLocalService userCredentialLocalService;
