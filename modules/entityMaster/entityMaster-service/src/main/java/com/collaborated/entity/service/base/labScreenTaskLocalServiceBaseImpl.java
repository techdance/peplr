...
import com.collaborated.entity.service.labScreenTaskLocalService;
...
/**
 * Provides the base implementation for the lab screen task local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.collaborated.entity.service.impl.labScreenTaskLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.collaborated.entity.service.impl.labScreenTaskLocalServiceImpl
 * @see com.collaborated.entity.service.labScreenTaskLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class labScreenTaskLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements labScreenTaskLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.collaborated.entity.service.labScreenTaskLocalServiceUtil} to access the lab screen task local service.
	 */
	...
	@Override
	public labScreenTask addlabScreenTask(labScreenTask labScreenTask) {
		labScreenTask.setNew(true);

		return labScreenTaskPersistence.update(labScreenTask);
	}
	 ...
	 */
	@Override
	public labScreenTask createlabScreenTask(long PK_taskId) {
		return labScreenTaskPersistence.create(PK_taskId);
	}
	...
	@Override
	public labScreenTask deletelabScreenTask(long PK_taskId)
		throws PortalException {
		return labScreenTaskPersistence.remove(PK_taskId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public labScreenTask deletelabScreenTask(labScreenTask labScreenTask) {
		return labScreenTaskPersistence.remove(labScreenTask);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(labScreenTask.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return labScreenTaskPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return labScreenTaskPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public labScreenTask fetchlabScreenTask(long PK_taskId) {
		return labScreenTaskPersistence.fetchByPrimaryKey(PK_taskId);
	}
	 ...
	 */
	@Override
	public labScreenTask getlabScreenTask(long PK_taskId)
		throws PortalException {
		return labScreenTaskPersistence.findByPrimaryKey(PK_taskId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(labScreenTaskLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(labScreenTask.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("PK_taskId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(labScreenTaskLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(labScreenTask.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("PK_taskId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return labScreenTaskLocalService.deletelabScreenTask((labScreenTask)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return labScreenTaskPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<labScreenTask> getlabScreenTasks(int start, int end) {
		return labScreenTaskPersistence.findAll(start, end);
	}
	...
	public int getlabScreenTasksCount() {
		return labScreenTaskPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public labScreenTask updatelabScreenTask(labScreenTask labScreenTask) {
		return labScreenTaskPersistence.update(labScreenTask);
	}
	 ...
	 */
	public labScreenTaskLocalService getlabScreenTaskLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.collaborated.entity.model.labScreenTask",
			labScreenTaskLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.collaborated.entity.model.labScreenTask");
	}
	...
	public String getOSGiServiceIdentifier() {
		return labScreenTaskLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = labScreenTaskPersistence.getDataSource();
	...
	@BeanReference(type = labScreenTaskLocalService.class)
	protected labScreenTaskLocalService labScreenTaskLocalService;
