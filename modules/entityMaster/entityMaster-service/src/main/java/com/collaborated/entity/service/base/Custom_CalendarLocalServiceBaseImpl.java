...
import com.collaborated.entity.service.Custom_CalendarLocalService;
...
/**
 * Provides the base implementation for the custom_ calendar local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.collaborated.entity.service.impl.Custom_CalendarLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.collaborated.entity.service.impl.Custom_CalendarLocalServiceImpl
 * @see com.collaborated.entity.service.Custom_CalendarLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class Custom_CalendarLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements Custom_CalendarLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.collaborated.entity.service.Custom_CalendarLocalServiceUtil} to access the custom_ calendar local service.
	 */
	...
	@Override
	public Custom_Calendar addCustom_Calendar(Custom_Calendar custom_Calendar) {
		custom_Calendar.setNew(true);

		return custom_CalendarPersistence.update(custom_Calendar);
	}
	 ...
	 */
	@Override
	public Custom_Calendar createCustom_Calendar(long PK_calendarEventId) {
		return custom_CalendarPersistence.create(PK_calendarEventId);
	}
	...
	@Override
	public Custom_Calendar deleteCustom_Calendar(long PK_calendarEventId)
		throws PortalException {
		return custom_CalendarPersistence.remove(PK_calendarEventId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Custom_Calendar deleteCustom_Calendar(
		Custom_Calendar custom_Calendar) {
		return custom_CalendarPersistence.remove(custom_Calendar);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Custom_Calendar.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return custom_CalendarPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return custom_CalendarPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Custom_Calendar fetchCustom_Calendar(long PK_calendarEventId) {
		return custom_CalendarPersistence.fetchByPrimaryKey(PK_calendarEventId);
	}
	 ...
	 */
	@Override
	public Custom_Calendar getCustom_Calendar(long PK_calendarEventId)
		throws PortalException {
		return custom_CalendarPersistence.findByPrimaryKey(PK_calendarEventId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(custom_CalendarLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Custom_Calendar.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("PK_calendarEventId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(custom_CalendarLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Custom_Calendar.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return custom_CalendarLocalService.deleteCustom_Calendar((Custom_Calendar)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return custom_CalendarPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Custom_Calendar> getCustom_Calendars(int start, int end) {
		return custom_CalendarPersistence.findAll(start, end);
	}
	...
	public int getCustom_CalendarsCount() {
		return custom_CalendarPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Custom_Calendar updateCustom_Calendar(
		Custom_Calendar custom_Calendar) {
		return custom_CalendarPersistence.update(custom_Calendar);
	}
	 ...
	 */
	public Custom_CalendarLocalService getCustom_CalendarLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.collaborated.entity.model.Custom_Calendar",
			custom_CalendarLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.collaborated.entity.model.Custom_Calendar");
	}
	...
	public String getOSGiServiceIdentifier() {
		return Custom_CalendarLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = custom_CalendarPersistence.getDataSource();
	...
	@BeanReference(type = Custom_CalendarLocalService.class)
	protected Custom_CalendarLocalService custom_CalendarLocalService;
