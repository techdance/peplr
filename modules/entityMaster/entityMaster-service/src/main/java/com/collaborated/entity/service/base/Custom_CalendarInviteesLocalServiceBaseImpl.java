...
import com.collaborated.entity.service.Custom_CalendarInviteesLocalService;
...
/**
 * Provides the base implementation for the custom_ calendar invitees local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.collaborated.entity.service.impl.Custom_CalendarInviteesLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.collaborated.entity.service.impl.Custom_CalendarInviteesLocalServiceImpl
 * @see com.collaborated.entity.service.Custom_CalendarInviteesLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class Custom_CalendarInviteesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements Custom_CalendarInviteesLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.collaborated.entity.service.Custom_CalendarInviteesLocalServiceUtil} to access the custom_ calendar invitees local service.
	 */
	...
	public Custom_CalendarInvitees addCustom_CalendarInvitees(
		...
		return custom_CalendarInviteesPersistence.update(custom_CalendarInvitees);
	}
	...
	public Custom_CalendarInvitees createCustom_CalendarInvitees(
		...
		return custom_CalendarInviteesPersistence.create(PK_calendarEventSubId);
	}
	...
	public Custom_CalendarInvitees deleteCustom_CalendarInvitees(
		...
		return custom_CalendarInviteesPersistence.remove(PK_calendarEventSubId);
	}
	...
	public Custom_CalendarInvitees deleteCustom_CalendarInvitees(
		Custom_CalendarInvitees custom_CalendarInvitees) {
		return custom_CalendarInviteesPersistence.remove(custom_CalendarInvitees);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Custom_CalendarInvitees.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return custom_CalendarInviteesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return custom_CalendarInviteesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public Custom_CalendarInvitees fetchCustom_CalendarInvitees(
		long PK_calendarEventSubId) {
		return custom_CalendarInviteesPersistence.fetchByPrimaryKey(PK_calendarEventSubId);
	}
	...
	public Custom_CalendarInvitees getCustom_CalendarInvitees(
		long PK_calendarEventSubId) throws PortalException {
		return custom_CalendarInviteesPersistence.findByPrimaryKey(PK_calendarEventSubId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(custom_CalendarInviteesLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Custom_CalendarInvitees.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(custom_CalendarInviteesLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Custom_CalendarInvitees.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return custom_CalendarInviteesLocalService.deleteCustom_CalendarInvitees((Custom_CalendarInvitees)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return custom_CalendarInviteesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Custom_CalendarInvitees> getCustom_CalendarInviteeses(
		int start, int end) {
		return custom_CalendarInviteesPersistence.findAll(start, end);
	}
	...
	public int getCustom_CalendarInviteesesCount() {
		return custom_CalendarInviteesPersistence.countAll();
	}
	 ...
	 */
	public Custom_CalendarInviteesLocalService getCustom_CalendarInviteesLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.collaborated.entity.model.Custom_CalendarInvitees",
			custom_CalendarInviteesLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.collaborated.entity.model.Custom_CalendarInvitees");
	}
	...
	public String getOSGiServiceIdentifier() {
		return Custom_CalendarInviteesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = custom_CalendarInviteesPersistence.getDataSource();
	...
	@BeanReference(type = Custom_CalendarInviteesLocalService.class)
	protected Custom_CalendarInviteesLocalService custom_CalendarInviteesLocalService;
