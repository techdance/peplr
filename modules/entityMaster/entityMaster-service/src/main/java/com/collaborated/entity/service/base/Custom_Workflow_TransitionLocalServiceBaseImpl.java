...
import com.collaborated.entity.service.Custom_Workflow_TransitionLocalService;
...
/**
 * Provides the base implementation for the custom_ workflow_ transition local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.collaborated.entity.service.impl.Custom_Workflow_TransitionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.collaborated.entity.service.impl.Custom_Workflow_TransitionLocalServiceImpl
 * @see com.collaborated.entity.service.Custom_Workflow_TransitionLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class Custom_Workflow_TransitionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements Custom_Workflow_TransitionLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.collaborated.entity.service.Custom_Workflow_TransitionLocalServiceUtil} to access the custom_ workflow_ transition local service.
	 */
	...
	@Override
	public Custom_Workflow_Transition addCustom_Workflow_Transition(
	 ...
	 */
	@Override
	public Custom_Workflow_Transition createCustom_Workflow_Transition(
		long transitionId) {
		return custom_Workflow_TransitionPersistence.create(transitionId);
	}
	...
	@Override
	public Custom_Workflow_Transition deleteCustom_Workflow_Transition(
		long transitionId) throws PortalException {
		return custom_Workflow_TransitionPersistence.remove(transitionId);
	}
	...
	public Custom_Workflow_Transition deleteCustom_Workflow_Transition(
		Custom_Workflow_Transition custom_Workflow_Transition) {
		return custom_Workflow_TransitionPersistence.remove(custom_Workflow_Transition);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Custom_Workflow_Transition.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return custom_Workflow_TransitionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return custom_Workflow_TransitionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Custom_Workflow_Transition fetchCustom_Workflow_Transition(
		long transitionId) {
		return custom_Workflow_TransitionPersistence.fetchByPrimaryKey(transitionId);
	}
	 ...
	 */
	@Override
	public Custom_Workflow_Transition getCustom_Workflow_Transition(
		long transitionId) throws PortalException {
		return custom_Workflow_TransitionPersistence.findByPrimaryKey(transitionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(custom_Workflow_TransitionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Custom_Workflow_Transition.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(custom_Workflow_TransitionLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Custom_Workflow_Transition.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return custom_Workflow_TransitionLocalService.deleteCustom_Workflow_Transition((Custom_Workflow_Transition)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return custom_Workflow_TransitionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Custom_Workflow_Transition> getCustom_Workflow_Transitions(
		int start, int end) {
		return custom_Workflow_TransitionPersistence.findAll(start, end);
	}
	...
	public int getCustom_Workflow_TransitionsCount() {
		return custom_Workflow_TransitionPersistence.countAll();
	}
	 ...
	 */
	public Custom_Workflow_TransitionLocalService getCustom_Workflow_TransitionLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.collaborated.entity.model.Custom_Workflow_Transition",
			custom_Workflow_TransitionLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.collaborated.entity.model.Custom_Workflow_Transition");
	}
	...
	public String getOSGiServiceIdentifier() {
		return Custom_Workflow_TransitionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = custom_Workflow_TransitionPersistence.getDataSource();
	...
	@BeanReference(type = Custom_Workflow_TransitionLocalService.class)
	protected Custom_Workflow_TransitionLocalService custom_Workflow_TransitionLocalService;
