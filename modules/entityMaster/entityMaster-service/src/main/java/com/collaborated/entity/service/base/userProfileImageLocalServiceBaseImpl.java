...
import com.collaborated.entity.service.userProfileImageLocalService;
...
/**
 * Provides the base implementation for the user profile image local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.collaborated.entity.service.impl.userProfileImageLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.collaborated.entity.service.impl.userProfileImageLocalServiceImpl
 * @see com.collaborated.entity.service.userProfileImageLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class userProfileImageLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements userProfileImageLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.collaborated.entity.service.userProfileImageLocalServiceUtil} to access the user profile image local service.
	 */
	...
	public userProfileImage adduserProfileImage(
		...
		return userProfileImagePersistence.update(userProfileImage);
	}
	...
	public userProfileImage createuserProfileImage(long PK_profileImageId) {
		return userProfileImagePersistence.create(PK_profileImageId);
	}
	...
	public userProfileImage deleteuserProfileImage(long PK_profileImageId)
		...
		return userProfileImagePersistence.remove(PK_profileImageId);
	}
	...
	public userProfileImage deleteuserProfileImage(
		userProfileImage userProfileImage) {
		return userProfileImagePersistence.remove(userProfileImage);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(userProfileImage.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return userProfileImagePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return userProfileImagePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public userProfileImage fetchuserProfileImage(long PK_profileImageId) {
		return userProfileImagePersistence.fetchByPrimaryKey(PK_profileImageId);
	}
	...
	public userProfileImage getuserProfileImage(long PK_profileImageId)
		throws PortalException {
		return userProfileImagePersistence.findByPrimaryKey(PK_profileImageId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(userProfileImageLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(userProfileImage.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("PK_profileImageId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(userProfileImageLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(userProfileImage.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return userProfileImageLocalService.deleteuserProfileImage((userProfileImage)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return userProfileImagePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<userProfileImage> getuserProfileImages(int start, int end) {
		return userProfileImagePersistence.findAll(start, end);
	}
	...
	public int getuserProfileImagesCount() {
		return userProfileImagePersistence.countAll();
	}
	...
	public userProfileImageBlobDataBlobModel getBlobDataBlobModel(
		...
		try {
			session = userProfileImagePersistence.openSession();

			return (userProfileImageBlobDataBlobModel)session.get(userProfileImageBlobDataBlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
			throw userProfileImagePersistence.processException(e);
		}
		finally {
			userProfileImagePersistence.closeSession(session);
		}
	}
	 ...
	 */
	public userProfileImageLocalService getuserProfileImageLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.collaborated.entity.model.userProfileImage",
			userProfileImageLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.collaborated.entity.model.userProfileImage");
	}
	...
	public String getOSGiServiceIdentifier() {
		return userProfileImageLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = userProfileImagePersistence.getDataSource();
	...
	@BeanReference(type = userProfileImageLocalService.class)
	protected userProfileImageLocalService userProfileImageLocalService;
