...
import com.collaborated.entity.service.projectDiscussionLocalService;
...
/**
 * Provides the base implementation for the project discussion local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.collaborated.entity.service.impl.projectDiscussionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.collaborated.entity.service.impl.projectDiscussionLocalServiceImpl
 * @see com.collaborated.entity.service.projectDiscussionLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class projectDiscussionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements projectDiscussionLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.collaborated.entity.service.projectDiscussionLocalServiceUtil} to access the project discussion local service.
	 */
	...
	@Override
	public projectDiscussion addprojectDiscussion(
		projectDiscussion projectDiscussion) {
		projectDiscussion.setNew(true);

		return projectDiscussionPersistence.update(projectDiscussion);
	}
	 ...
	 */
	@Override
	public projectDiscussion createprojectDiscussion(
		long PK_projectDiscussionId) {
		return projectDiscussionPersistence.create(PK_projectDiscussionId);
	}
	...
	@Override
	public projectDiscussion deleteprojectDiscussion(
		long PK_projectDiscussionId) throws PortalException {
		return projectDiscussionPersistence.remove(PK_projectDiscussionId);
	}
	...
	public projectDiscussion deleteprojectDiscussion(
		projectDiscussion projectDiscussion) {
		return projectDiscussionPersistence.remove(projectDiscussion);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(projectDiscussion.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return projectDiscussionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return projectDiscussionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public projectDiscussion fetchprojectDiscussion(long PK_projectDiscussionId) {
		return projectDiscussionPersistence.fetchByPrimaryKey(PK_projectDiscussionId);
	}
	 ...
	 */
	@Override
	public projectDiscussion getprojectDiscussion(long PK_projectDiscussionId)
		throws PortalException {
		return projectDiscussionPersistence.findByPrimaryKey(PK_projectDiscussionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(projectDiscussionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(projectDiscussion.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(projectDiscussionLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(projectDiscussion.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return projectDiscussionLocalService.deleteprojectDiscussion((projectDiscussion)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return projectDiscussionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<projectDiscussion> getprojectDiscussions(int start, int end) {
		return projectDiscussionPersistence.findAll(start, end);
	}
	...
	public int getprojectDiscussionsCount() {
		return projectDiscussionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public projectDiscussion updateprojectDiscussion(
		projectDiscussion projectDiscussion) {
		return projectDiscussionPersistence.update(projectDiscussion);
	}
	 ...
	 */
	public projectDiscussionLocalService getprojectDiscussionLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.collaborated.entity.model.projectDiscussion",
			projectDiscussionLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.collaborated.entity.model.projectDiscussion");
	}
	...
	public String getOSGiServiceIdentifier() {
		return projectDiscussionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = projectDiscussionPersistence.getDataSource();
	...
	@BeanReference(type = projectDiscussionLocalService.class)
	protected projectDiscussionLocalService projectDiscussionLocalService;
