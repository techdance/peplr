...
import com.collaborated.entity.service.labDetailedCourseObjectivesLocalService;
...
/**
 * Provides the base implementation for the lab detailed course objectives local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.collaborated.entity.service.impl.labDetailedCourseObjectivesLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.collaborated.entity.service.impl.labDetailedCourseObjectivesLocalServiceImpl
 * @see com.collaborated.entity.service.labDetailedCourseObjectivesLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class labDetailedCourseObjectivesLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements labDetailedCourseObjectivesLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.collaborated.entity.service.labDetailedCourseObjectivesLocalServiceUtil} to access the lab detailed course objectives local service.
	 */
	...
	@Override
	public labDetailedCourseObjectives addlabDetailedCourseObjectives(
		labDetailedCourseObjectives labDetailedCourseObjectives) {
		labDetailedCourseObjectives.setNew(true);

		return labDetailedCourseObjectivesPersistence.update(labDetailedCourseObjectives);
	}
	 ...
	 */
	@Override
	public labDetailedCourseObjectives createlabDetailedCourseObjectives(
		long PK_courseObjectivesId) {
		return labDetailedCourseObjectivesPersistence.create(PK_courseObjectivesId);
	}
	...
	@Override
	public labDetailedCourseObjectives deletelabDetailedCourseObjectives(
		long PK_courseObjectivesId) throws PortalException {
		return labDetailedCourseObjectivesPersistence.remove(PK_courseObjectivesId);
	}
	...
	public labDetailedCourseObjectives deletelabDetailedCourseObjectives(
		labDetailedCourseObjectives labDetailedCourseObjectives) {
		return labDetailedCourseObjectivesPersistence.remove(labDetailedCourseObjectives);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(labDetailedCourseObjectives.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return labDetailedCourseObjectivesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return labDetailedCourseObjectivesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public labDetailedCourseObjectives fetchlabDetailedCourseObjectives(
		long PK_courseObjectivesId) {
		return labDetailedCourseObjectivesPersistence.fetchByPrimaryKey(PK_courseObjectivesId);
	}
	 ...
	 */
	@Override
	public labDetailedCourseObjectives getlabDetailedCourseObjectives(
		long PK_courseObjectivesId) throws PortalException {
		return labDetailedCourseObjectivesPersistence.findByPrimaryKey(PK_courseObjectivesId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(labDetailedCourseObjectivesLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(labDetailedCourseObjectives.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(labDetailedCourseObjectivesLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(labDetailedCourseObjectives.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return labDetailedCourseObjectivesLocalService.deletelabDetailedCourseObjectives((labDetailedCourseObjectives)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return labDetailedCourseObjectivesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<labDetailedCourseObjectives> getlabDetailedCourseObjectiveses(
		int start, int end) {
		return labDetailedCourseObjectivesPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getlabDetailedCourseObjectivesesCount() {
		return labDetailedCourseObjectivesPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public labDetailedCourseObjectives updatelabDetailedCourseObjectives(
		labDetailedCourseObjectives labDetailedCourseObjectives) {
		return labDetailedCourseObjectivesPersistence.update(labDetailedCourseObjectives);
	}
	 ...
	 */
	public labDetailedCourseObjectivesLocalService getlabDetailedCourseObjectivesLocalService() {
	...
	public void setlabDetailedCourseObjectivesLocalService(
		labDetailedCourseObjectivesLocalService labDetailedCourseObjectivesLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.collaborated.entity.model.labDetailedCourseObjectives",
			labDetailedCourseObjectivesLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.collaborated.entity.model.labDetailedCourseObjectives");
	}
	...
	public String getOSGiServiceIdentifier() {
		return labDetailedCourseObjectivesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = labDetailedCourseObjectivesPersistence.getDataSource();
	...
	@BeanReference(type = labDetailedCourseObjectivesLocalService.class)
	protected labDetailedCourseObjectivesLocalService labDetailedCourseObjectivesLocalService;
