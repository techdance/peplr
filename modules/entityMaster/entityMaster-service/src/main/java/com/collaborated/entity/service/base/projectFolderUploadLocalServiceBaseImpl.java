...
import com.collaborated.entity.service.projectFolderUploadLocalService;
...
/**
 * Provides the base implementation for the project folder upload local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.collaborated.entity.service.impl.projectFolderUploadLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.collaborated.entity.service.impl.projectFolderUploadLocalServiceImpl
 * @see com.collaborated.entity.service.projectFolderUploadLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class projectFolderUploadLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements projectFolderUploadLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.collaborated.entity.service.projectFolderUploadLocalServiceUtil} to access the project folder upload local service.
	 */
	...
	public projectFolderUpload addprojectFolderUpload(
		...
		return projectFolderUploadPersistence.update(projectFolderUpload);
	}
	...
	public projectFolderUpload createprojectFolderUpload(
		...
		return projectFolderUploadPersistence.create(PK_projectFolderId);
	}
	...
	public projectFolderUpload deleteprojectFolderUpload(
		...
		return projectFolderUploadPersistence.remove(PK_projectFolderId);
	}
	...
	public projectFolderUpload deleteprojectFolderUpload(
		projectFolderUpload projectFolderUpload) {
		return projectFolderUploadPersistence.remove(projectFolderUpload);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(projectFolderUpload.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return projectFolderUploadPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return projectFolderUploadPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public projectFolderUpload fetchprojectFolderUpload(long PK_projectFolderId) {
		return projectFolderUploadPersistence.fetchByPrimaryKey(PK_projectFolderId);
	}
	...
	public projectFolderUpload getprojectFolderUpload(long PK_projectFolderId)
		...
		return projectFolderUploadPersistence.findByPrimaryKey(PK_projectFolderId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(projectFolderUploadLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(projectFolderUpload.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("PK_projectFolderId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(projectFolderUploadLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(projectFolderUpload.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return projectFolderUploadLocalService.deleteprojectFolderUpload((projectFolderUpload)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return projectFolderUploadPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<projectFolderUpload> getprojectFolderUploads(int start, int end) {
		return projectFolderUploadPersistence.findAll(start, end);
	}
	...
	public int getprojectFolderUploadsCount() {
		return projectFolderUploadPersistence.countAll();
	}
	 ...
	 */
	public projectFolderUploadLocalService getprojectFolderUploadLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.collaborated.entity.model.projectFolderUpload",
			projectFolderUploadLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.collaborated.entity.model.projectFolderUpload");
	}
	...
	public String getOSGiServiceIdentifier() {
		return projectFolderUploadLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = projectFolderUploadPersistence.getDataSource();
	...
	@BeanReference(type = projectFolderUploadLocalService.class)
	protected projectFolderUploadLocalService projectFolderUploadLocalService;
