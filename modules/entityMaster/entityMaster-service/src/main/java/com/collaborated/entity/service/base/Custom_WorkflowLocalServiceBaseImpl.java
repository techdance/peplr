...
import com.collaborated.entity.service.Custom_WorkflowLocalService;
...
/**
 * Provides the base implementation for the custom_ workflow local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.collaborated.entity.service.impl.Custom_WorkflowLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.collaborated.entity.service.impl.Custom_WorkflowLocalServiceImpl
 * @see com.collaborated.entity.service.Custom_WorkflowLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class Custom_WorkflowLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements Custom_WorkflowLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.collaborated.entity.service.Custom_WorkflowLocalServiceUtil} to access the custom_ workflow local service.
	 */
	...
	@Override
	public Custom_Workflow addCustom_Workflow(Custom_Workflow custom_Workflow) {
		custom_Workflow.setNew(true);

		return custom_WorkflowPersistence.update(custom_Workflow);
	}
	 ...
	 */
	@Override
	public Custom_Workflow createCustom_Workflow(long workFlowId) {
		return custom_WorkflowPersistence.create(workFlowId);
	}
	...
	@Override
	public Custom_Workflow deleteCustom_Workflow(long workFlowId)
		throws PortalException {
		return custom_WorkflowPersistence.remove(workFlowId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Custom_Workflow deleteCustom_Workflow(
		Custom_Workflow custom_Workflow) {
		return custom_WorkflowPersistence.remove(custom_Workflow);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Custom_Workflow.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return custom_WorkflowPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return custom_WorkflowPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Custom_Workflow fetchCustom_Workflow(long workFlowId) {
		return custom_WorkflowPersistence.fetchByPrimaryKey(workFlowId);
	}
	 ...
	 */
	@Override
	public Custom_Workflow getCustom_Workflow(long workFlowId)
		throws PortalException {
		return custom_WorkflowPersistence.findByPrimaryKey(workFlowId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(custom_WorkflowLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Custom_Workflow.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(custom_WorkflowLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Custom_Workflow.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return custom_WorkflowLocalService.deleteCustom_Workflow((Custom_Workflow)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return custom_WorkflowPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Custom_Workflow> getCustom_Workflows(int start, int end) {
		return custom_WorkflowPersistence.findAll(start, end);
	}
	...
	public int getCustom_WorkflowsCount() {
		return custom_WorkflowPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Custom_Workflow updateCustom_Workflow(
		Custom_Workflow custom_Workflow) {
		return custom_WorkflowPersistence.update(custom_Workflow);
	}
	 ...
	 */
	public Custom_WorkflowLocalService getCustom_WorkflowLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.collaborated.entity.model.Custom_Workflow",
			custom_WorkflowLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.collaborated.entity.model.Custom_Workflow");
	}
	...
	public String getOSGiServiceIdentifier() {
		return Custom_WorkflowLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = custom_WorkflowPersistence.getDataSource();
	...
	@BeanReference(type = Custom_WorkflowLocalService.class)
	protected Custom_WorkflowLocalService custom_WorkflowLocalService;
