...
import com.collaborated.entity.service.Custom_Workflow_TaskLocalService;
...
/**
 * Provides the base implementation for the custom_ workflow_ task local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.collaborated.entity.service.impl.Custom_Workflow_TaskLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.collaborated.entity.service.impl.Custom_Workflow_TaskLocalServiceImpl
 * @see com.collaborated.entity.service.Custom_Workflow_TaskLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class Custom_Workflow_TaskLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements Custom_Workflow_TaskLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.collaborated.entity.service.Custom_Workflow_TaskLocalServiceUtil} to access the custom_ workflow_ task local service.
	 */
	...
	@Override
	public Custom_Workflow_Task addCustom_Workflow_Task(
		Custom_Workflow_Task custom_Workflow_Task) {
		custom_Workflow_Task.setNew(true);

		return custom_Workflow_TaskPersistence.update(custom_Workflow_Task);
	}
	 ...
	 */
	@Override
	public Custom_Workflow_Task createCustom_Workflow_Task(
		String workFlowTaskId) {
		return custom_Workflow_TaskPersistence.create(workFlowTaskId);
	}
	...
	@Override
	public Custom_Workflow_Task deleteCustom_Workflow_Task(
		String workFlowTaskId) throws PortalException {
		return custom_Workflow_TaskPersistence.remove(workFlowTaskId);
	}
	...
	public Custom_Workflow_Task deleteCustom_Workflow_Task(
		Custom_Workflow_Task custom_Workflow_Task) {
		return custom_Workflow_TaskPersistence.remove(custom_Workflow_Task);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Custom_Workflow_Task.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return custom_Workflow_TaskPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return custom_Workflow_TaskPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Custom_Workflow_Task fetchCustom_Workflow_Task(String workFlowTaskId) {
		return custom_Workflow_TaskPersistence.fetchByPrimaryKey(workFlowTaskId);
	}
	 ...
	 */
	@Override
	public Custom_Workflow_Task getCustom_Workflow_Task(String workFlowTaskId)
		throws PortalException {
		return custom_Workflow_TaskPersistence.findByPrimaryKey(workFlowTaskId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return custom_Workflow_TaskLocalService.deleteCustom_Workflow_Task((Custom_Workflow_Task)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return custom_Workflow_TaskPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Custom_Workflow_Task> getCustom_Workflow_Tasks(int start,
		int end) {
		return custom_Workflow_TaskPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCustom_Workflow_TasksCount() {
		return custom_Workflow_TaskPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Custom_Workflow_Task updateCustom_Workflow_Task(
		Custom_Workflow_Task custom_Workflow_Task) {
		return custom_Workflow_TaskPersistence.update(custom_Workflow_Task);
	}
	 ...
	 */
	public Custom_Workflow_TaskLocalService getCustom_Workflow_TaskLocalService() {
	...
	public void setCustom_Workflow_TaskLocalService(
		Custom_Workflow_TaskLocalService custom_Workflow_TaskLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.collaborated.entity.model.Custom_Workflow_Task",
			custom_Workflow_TaskLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.collaborated.entity.model.Custom_Workflow_Task");
	}
	...
	public String getOSGiServiceIdentifier() {
		return Custom_Workflow_TaskLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = custom_Workflow_TaskPersistence.getDataSource();
	...
	@BeanReference(type = Custom_Workflow_TaskLocalService.class)
	protected Custom_Workflow_TaskLocalService custom_Workflow_TaskLocalService;
