...
import com.collaborated.entity.service.labDetailedActivityTableLocalService;
...
/**
 * Provides the base implementation for the lab detailed activity table local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.collaborated.entity.service.impl.labDetailedActivityTableLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.collaborated.entity.service.impl.labDetailedActivityTableLocalServiceImpl
 * @see com.collaborated.entity.service.labDetailedActivityTableLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class labDetailedActivityTableLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements labDetailedActivityTableLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.collaborated.entity.service.labDetailedActivityTableLocalServiceUtil} to access the lab detailed activity table local service.
	 */
	...
	@Override
	public labDetailedActivityTable addlabDetailedActivityTable(
		labDetailedActivityTable labDetailedActivityTable) {
		labDetailedActivityTable.setNew(true);

		return labDetailedActivityTablePersistence.update(labDetailedActivityTable);
	}
	 ...
	 */
	@Override
	public labDetailedActivityTable createlabDetailedActivityTable(
		long PK_activityTableId) {
		return labDetailedActivityTablePersistence.create(PK_activityTableId);
	}
	...
	@Override
	public labDetailedActivityTable deletelabDetailedActivityTable(
		long PK_activityTableId) throws PortalException {
		return labDetailedActivityTablePersistence.remove(PK_activityTableId);
	}
	...
	public labDetailedActivityTable deletelabDetailedActivityTable(
		labDetailedActivityTable labDetailedActivityTable) {
		return labDetailedActivityTablePersistence.remove(labDetailedActivityTable);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(labDetailedActivityTable.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return labDetailedActivityTablePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return labDetailedActivityTablePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public labDetailedActivityTable fetchlabDetailedActivityTable(
		long PK_activityTableId) {
		return labDetailedActivityTablePersistence.fetchByPrimaryKey(PK_activityTableId);
	}
	 ...
	 */
	@Override
	public labDetailedActivityTable getlabDetailedActivityTable(
		long PK_activityTableId) throws PortalException {
		return labDetailedActivityTablePersistence.findByPrimaryKey(PK_activityTableId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(labDetailedActivityTableLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(labDetailedActivityTable.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("PK_activityTableId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(labDetailedActivityTableLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(labDetailedActivityTable.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return labDetailedActivityTableLocalService.deletelabDetailedActivityTable((labDetailedActivityTable)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return labDetailedActivityTablePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<labDetailedActivityTable> getlabDetailedActivityTables(
		int start, int end) {
		return labDetailedActivityTablePersistence.findAll(start, end);
	}
	...
	public int getlabDetailedActivityTablesCount() {
		return labDetailedActivityTablePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public labDetailedActivityTable updatelabDetailedActivityTable(
		labDetailedActivityTable labDetailedActivityTable) {
		return labDetailedActivityTablePersistence.update(labDetailedActivityTable);
	}
	 ...
	 */
	public labDetailedActivityTableLocalService getlabDetailedActivityTableLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.collaborated.entity.model.labDetailedActivityTable",
			labDetailedActivityTableLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.collaborated.entity.model.labDetailedActivityTable");
	}
	...
	public String getOSGiServiceIdentifier() {
		return labDetailedActivityTableLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = labDetailedActivityTablePersistence.getDataSource();
	...
	@BeanReference(type = labDetailedActivityTableLocalService.class)
	protected labDetailedActivityTableLocalService labDetailedActivityTableLocalService;
