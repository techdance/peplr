...
import com.collaborated.entity.service.discussionMessageNotificationLocalService;
...
/**
 * Provides the base implementation for the discussion message notification local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.collaborated.entity.service.impl.discussionMessageNotificationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.collaborated.entity.service.impl.discussionMessageNotificationLocalServiceImpl
 * @see com.collaborated.entity.service.discussionMessageNotificationLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class discussionMessageNotificationLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.collaborated.entity.service.discussionMessageNotificationLocalServiceUtil} to access the discussion message notification local service.
	 */
	...
	@Override
	public discussionMessageNotification adddiscussionMessageNotification(
		discussionMessageNotification discussionMessageNotification) {
		discussionMessageNotification.setNew(true);

		return discussionMessageNotificationPersistence.update(discussionMessageNotification);
	}
	 ...
	 */
	@Override
	public discussionMessageNotification creatediscussionMessageNotification(
		long PK_discussionNotificationId) {
		return discussionMessageNotificationPersistence.create(PK_discussionNotificationId);
	}
	...
	@Override
	public discussionMessageNotification deletediscussionMessageNotification(
		long PK_discussionNotificationId) throws PortalException {
		return discussionMessageNotificationPersistence.remove(PK_discussionNotificationId);
	}
	...
	public discussionMessageNotification deletediscussionMessageNotification(
		discussionMessageNotification discussionMessageNotification) {
		return discussionMessageNotificationPersistence.remove(discussionMessageNotification);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(discussionMessageNotification.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return discussionMessageNotificationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return discussionMessageNotificationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public discussionMessageNotification fetchdiscussionMessageNotification(
		long PK_discussionNotificationId) {
		return discussionMessageNotificationPersistence.fetchByPrimaryKey(PK_discussionNotificationId);
	}
	 ...
	 */
	@Override
	public discussionMessageNotification getdiscussionMessageNotification(
		long PK_discussionNotificationId) throws PortalException {
		return discussionMessageNotificationPersistence.findByPrimaryKey(PK_discussionNotificationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(discussionMessageNotificationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(discussionMessageNotification.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(discussionMessageNotificationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(discussionMessageNotification.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return discussionMessageNotificationLocalService.deletediscussionMessageNotification((discussionMessageNotification)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return discussionMessageNotificationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<discussionMessageNotification> getdiscussionMessageNotifications(
		int start, int end) {
		return discussionMessageNotificationPersistence.findAll(start, end);
	}
	...
	public int getdiscussionMessageNotificationsCount() {
		return discussionMessageNotificationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public discussionMessageNotification updatediscussionMessageNotification(
		discussionMessageNotification discussionMessageNotification) {
		return discussionMessageNotificationPersistence.update(discussionMessageNotification);
	}
	 ...
	 */
	public discussionMessageNotificationLocalService getdiscussionMessageNotificationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.collaborated.entity.model.discussionMessageNotification",
			discussionMessageNotificationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.collaborated.entity.model.discussionMessageNotification");
	}
	...
	public String getOSGiServiceIdentifier() {
		return discussionMessageNotificationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = discussionMessageNotificationPersistence.getDataSource();
	...
	@BeanReference(type = discussionMessageNotificationLocalService.class)
	protected discussionMessageNotificationLocalService discussionMessageNotificationLocalService;
