...
import com.collaborated.entity.service.Custom_WorkflowLogLocalService;
...
/**
 * Provides the base implementation for the custom_ workflow log local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.collaborated.entity.service.impl.Custom_WorkflowLogLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.collaborated.entity.service.impl.Custom_WorkflowLogLocalServiceImpl
 * @see com.collaborated.entity.service.Custom_WorkflowLogLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class Custom_WorkflowLogLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements Custom_WorkflowLogLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.collaborated.entity.service.Custom_WorkflowLogLocalServiceUtil} to access the custom_ workflow log local service.
	 */
	...
	public Custom_WorkflowLog addCustom_WorkflowLog(
		...
		return custom_WorkflowLogPersistence.update(custom_WorkflowLog);
	}
	...
	public Custom_WorkflowLog createCustom_WorkflowLog(long logId) {
		return custom_WorkflowLogPersistence.create(logId);
	}
	...
	public Custom_WorkflowLog deleteCustom_WorkflowLog(long logId)
		...
		return custom_WorkflowLogPersistence.remove(logId);
	}
	...
	public Custom_WorkflowLog deleteCustom_WorkflowLog(
		Custom_WorkflowLog custom_WorkflowLog) {
		return custom_WorkflowLogPersistence.remove(custom_WorkflowLog);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Custom_WorkflowLog.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return custom_WorkflowLogPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return custom_WorkflowLogPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public Custom_WorkflowLog fetchCustom_WorkflowLog(long logId) {
		return custom_WorkflowLogPersistence.fetchByPrimaryKey(logId);
	}
	...
	public Custom_WorkflowLog getCustom_WorkflowLog(long logId)
		throws PortalException {
		return custom_WorkflowLogPersistence.findByPrimaryKey(logId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(custom_WorkflowLogLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Custom_WorkflowLog.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(custom_WorkflowLogLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Custom_WorkflowLog.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return custom_WorkflowLogLocalService.deleteCustom_WorkflowLog((Custom_WorkflowLog)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return custom_WorkflowLogPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Custom_WorkflowLog> getCustom_WorkflowLogs(int start, int end) {
		return custom_WorkflowLogPersistence.findAll(start, end);
	}
	...
	public int getCustom_WorkflowLogsCount() {
		return custom_WorkflowLogPersistence.countAll();
	}
	 ...
	 */
	public Custom_WorkflowLogLocalService getCustom_WorkflowLogLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.collaborated.entity.model.Custom_WorkflowLog",
			custom_WorkflowLogLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.collaborated.entity.model.Custom_WorkflowLog");
	}
	...
	public String getOSGiServiceIdentifier() {
		return Custom_WorkflowLogLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = custom_WorkflowLogPersistence.getDataSource();
	...
	@BeanReference(type = Custom_WorkflowLogLocalService.class)
	protected Custom_WorkflowLogLocalService custom_WorkflowLogLocalService;
