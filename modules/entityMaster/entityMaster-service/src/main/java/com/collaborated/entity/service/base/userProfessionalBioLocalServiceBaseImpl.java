...
import com.collaborated.entity.service.userProfessionalBioLocalService;
...
/**
 * Provides the base implementation for the user professional bio local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.collaborated.entity.service.impl.userProfessionalBioLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.collaborated.entity.service.impl.userProfessionalBioLocalServiceImpl
 * @see com.collaborated.entity.service.userProfessionalBioLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class userProfessionalBioLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements userProfessionalBioLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.collaborated.entity.service.userProfessionalBioLocalServiceUtil} to access the user professional bio local service.
	 */
	...
	@Override
	public userProfessionalBio adduserProfessionalBio(
		userProfessionalBio userProfessionalBio) {
		userProfessionalBio.setNew(true);

		return userProfessionalBioPersistence.update(userProfessionalBio);
	}
	 ...
	 */
	@Override
	public userProfessionalBio createuserProfessionalBio(
		long PK_userProfessionalBio) {
		return userProfessionalBioPersistence.create(PK_userProfessionalBio);
	}
	...
	@Override
	public userProfessionalBio deleteuserProfessionalBio(
		long PK_userProfessionalBio) throws PortalException {
		return userProfessionalBioPersistence.remove(PK_userProfessionalBio);
	}
	...
	public userProfessionalBio deleteuserProfessionalBio(
		userProfessionalBio userProfessionalBio) {
		return userProfessionalBioPersistence.remove(userProfessionalBio);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(userProfessionalBio.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return userProfessionalBioPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return userProfessionalBioPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public userProfessionalBio fetchuserProfessionalBio(
		long PK_userProfessionalBio) {
		return userProfessionalBioPersistence.fetchByPrimaryKey(PK_userProfessionalBio);
	}
	 ...
	 */
	@Override
	public userProfessionalBio getuserProfessionalBio(
		long PK_userProfessionalBio) throws PortalException {
		return userProfessionalBioPersistence.findByPrimaryKey(PK_userProfessionalBio);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(userProfessionalBioLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(userProfessionalBio.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(userProfessionalBioLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(userProfessionalBio.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return userProfessionalBioLocalService.deleteuserProfessionalBio((userProfessionalBio)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return userProfessionalBioPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<userProfessionalBio> getuserProfessionalBios(int start, int end) {
		return userProfessionalBioPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getuserProfessionalBiosCount() {
		return userProfessionalBioPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public userProfessionalBio updateuserProfessionalBio(
		userProfessionalBio userProfessionalBio) {
		return userProfessionalBioPersistence.update(userProfessionalBio);
	}
	 ...
	 */
	public userProfessionalBioLocalService getuserProfessionalBioLocalService() {
	...
	public void setuserProfessionalBioLocalService(
		userProfessionalBioLocalService userProfessionalBioLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.collaborated.entity.model.userProfessionalBio",
			userProfessionalBioLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.collaborated.entity.model.userProfessionalBio");
	}
	...
	public String getOSGiServiceIdentifier() {
		return userProfessionalBioLocalService.class.getName();
	}
	...
	@BeanReference(type = userProfessionalBioLocalService.class)
	protected userProfessionalBioLocalService userProfessionalBioLocalService;
