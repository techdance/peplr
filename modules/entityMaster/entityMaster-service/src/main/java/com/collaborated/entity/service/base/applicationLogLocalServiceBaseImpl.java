...
import com.collaborated.entity.service.applicationLogLocalService;
...
/**
 * Provides the base implementation for the application log local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.collaborated.entity.service.impl.applicationLogLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.collaborated.entity.service.impl.applicationLogLocalServiceImpl
 * @see com.collaborated.entity.service.applicationLogLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class applicationLogLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements applicationLogLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.collaborated.entity.service.applicationLogLocalServiceUtil} to access the application log local service.
	 */
	...
	@Override
	public applicationLog addapplicationLog(applicationLog applicationLog) {
		applicationLog.setNew(true);

		return applicationLogPersistence.update(applicationLog);
	}
	 ...
	 */
	@Override
	public applicationLog createapplicationLog(long PK_logId) {
		return applicationLogPersistence.create(PK_logId);
	}
	...
	@Override
	public applicationLog deleteapplicationLog(long PK_logId)
		throws PortalException {
		return applicationLogPersistence.remove(PK_logId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public applicationLog deleteapplicationLog(applicationLog applicationLog) {
		return applicationLogPersistence.remove(applicationLog);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(applicationLog.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return applicationLogPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return applicationLogPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public applicationLog fetchapplicationLog(long PK_logId) {
		return applicationLogPersistence.fetchByPrimaryKey(PK_logId);
	}
	 ...
	 */
	@Override
	public applicationLog getapplicationLog(long PK_logId)
		throws PortalException {
		return applicationLogPersistence.findByPrimaryKey(PK_logId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(applicationLogLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(applicationLog.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("PK_logId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(applicationLogLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(applicationLog.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("PK_logId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return applicationLogLocalService.deleteapplicationLog((applicationLog)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return applicationLogPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<applicationLog> getapplicationLogs(int start, int end) {
		return applicationLogPersistence.findAll(start, end);
	}
	...
	public int getapplicationLogsCount() {
		return applicationLogPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public applicationLog updateapplicationLog(applicationLog applicationLog) {
		return applicationLogPersistence.update(applicationLog);
	}
	 ...
	 */
	public applicationLogLocalService getapplicationLogLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.collaborated.entity.model.applicationLog",
			applicationLogLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.collaborated.entity.model.applicationLog");
	}
	...
	public String getOSGiServiceIdentifier() {
		return applicationLogLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = applicationLogPersistence.getDataSource();
	...
	@BeanReference(type = applicationLogLocalService.class)
	protected applicationLogLocalService applicationLogLocalService;
