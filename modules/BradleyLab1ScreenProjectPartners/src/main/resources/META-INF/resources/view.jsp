			...
			<div id="projectPartners" class="row row-custom">
				<!-- <div class="col-md-4">
					<div class="item item-flex">
						...
						<div class="item-text">
							<div class="partner partner-name position-relative">
								Inez Campos- 7:42 AM WEST (+6 Hours)
							...
							<span class="partner partner-title">Professor of Business Management</span>
							<span class="partner partner-university">Universidade de Lisboa</span>
				...
				<div class="col-md-4">
					<div class="item item-flex">
						...
						<div class="item-text">
							...
							<span class="partner partner-title">Professor</span>
							<span class="partner partner-university">AHEA University, Iowa City Campus</span>
