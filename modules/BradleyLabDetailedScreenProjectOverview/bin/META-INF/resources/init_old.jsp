...
function updateDonut() {
	...
	$("#"+namespaceId+"milestoneName").val(percentage);
	/*if(donutPercentage!=100){
...
/* function getProjectPercentageLoad(){
	AUI().use('aui-io-request-deprecated', function(A){
		A.io.request("<portlet:resourceURL id='getProjectPercentageLoad'/>"
		,{
              method: 'get',
              data:{ 
              },
                    ...
                    {			                    	
                    	...
                    	if(data.week1){
                    		...
                    		for (var i=0; i<maxNumber1; i++) {
                    			$("#week1CLAC .week1CLACFooter").before("<tr><td class='text-center' id='week1CourseObjective"+i+"'></td><td class='text-center' id='week1LearningEnv"+i+"'></td><td class='text-center' id='week1Activity"+i+"'></td><td class='text-center' id='week1Content"+i+"'></td></tr>");
                    			
                    			 if(data.week1.courseObjective.length>0){
                    				$("#week1CourseObjective"+i).append(data.week1.courseObjective[i].courseObjective);
                        		}
                    			if(data.week1.learningEnv.length>0){
                    				$("#week1LearningEnv"+i).append(data.week1.learningEnv[i].learningEnvironment);
                        		}
                    			if(data.week1.activity.length>0){
                    				$("#week1Activity"+i).append(data.week1.activity[i].activity);
                        		}
                    			if(data.week1.content.length>0){
                    				$("#week1Content"+i).append(data.week1.content[i].content);
                        		} 
                    		}
                    	...
                    	if(data.week2){
                    		...
                    		for (var i=0; i<maxNumber2; i++) {
                    			$("#week2CLAC .week2CLACFooter").before("<tr><td class='text-center' id='week2CourseObjective"+i+"'></td><td class='text-center' id='week2LearningEnv"+i+"'></td><td class='text-center' id='week2Activity"+i+"'></td><td class='text-center' id='week2Content"+i+"'></td></tr>");
                    			
                    			 if(data.week2.courseObjective.length>0){
                    				$("#week2CourseObjective"+i).append(data.week2.courseObjective[i].courseObjective);
                        		}
                    			if(data.week2.learningEnv.length>0){
                    				$("#week2LearningEnv"+i).append(data.week2.learningEnv[i].learningEnvironment);
                        		}
                    			if(data.week2.activity.length>0){
                    				$("#week2Activity"+i).append(data.week2.activity[i].activity);
                        		}
                    			if(data.week2.content.length>0){
                    				$("#week2Content"+i).append(data.week2.content[i].content);
                        		} 
                    		}
                    	...
                    	if(data.week3){
                    		...
                    		for (var i=0; i<maxNumber3; i++) {
                    			$("#week3CLAC .week3CLACFooter").before("<tr><td class='text-center' id='week3CourseObjective"+i+"'></td><td class='text-center' id='week3LearningEnv"+i+"'></td><td class='text-center' id='week3Activity"+i+"'></td><td class='text-center' id='week3Content"+i+"'></td></tr>");
                    			
                    			 if(data.week3.courseObjective.length>0){
                    				$("#week3CourseObjective"+i).append(data.week3.courseObjective[i].courseObjective);
                        		}
                    			if(data.week3.learningEnv.length>0){
                    				$("#week3LearningEnv"+i).append(data.week3.learningEnv[i].learningEnvironment);
                        		}
                    			if(data.week3.activity.length>0){
                    				$("#week3Activity"+i).append(data.week3.activity[i].activity);
                        		}
                    			if(data.week3.content.length>0){
                    				$("#week3Content"+i).append(data.week3.content[i].content);
                        		} 
                    		}
                    	...
                    	if(data.week4){
                    		...
                    		for (var i=0; i<maxNumber4; i++) {
                    			$("#week4CLAC .week4CLACFooter").before("<tr><td class='text-center' id='week4CourseObjective"+i+"'></td><td class='text-center' id='week4LearningEnv"+i+"'></td><td class='text-center' id='week4Activity"+i+"'></td><td class='text-center' id='week4Content"+i+"'></td></tr>");
                    			
                    			 if(data.week4.courseObjective.length>0){
                    				$("#week4CourseObjective"+i).append(data.week4.courseObjective[i].courseObjective);
                        		}
                    			if(data.week4.learningEnv.length>0){
                    				$("#week4LearningEnv"+i).append(data.week4.learningEnv[i].learningEnvironment);
                        		}
                    			if(data.week4.activity.length>0){
                    				$("#week4Activity"+i).append(data.week4.activity[i].activity);
                        		}
                    			if(data.week4.content.length>0){
                    				$("#week4Content"+i).append(data.week4.content[i].content);
                        		} 
                    		}
              ...
              on:{
           	   complete:function()
                   ...
                   {			                    	
                   	var value=this.get('responseData');
                   	loadWeekWiseData();
					if(value!="" && value!="undefined" && value!=undefined && value=="delete"){
