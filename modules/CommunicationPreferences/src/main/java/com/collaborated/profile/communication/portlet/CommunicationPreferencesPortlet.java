package com.collaborated.profile.communication.portlet;
...
public class CommunicationPreferencesPortlet extends MVCPortlet {
	...
	public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
		...
		/*long primaryLanguageID = 0;
		long secondaryLanguageID = 0;
		long tertiaryLanguageID = 0;
		
		PortletSession portletSession = renderRequest.getPortletSession();
		
		try{
			primaryLanguageID = (long)portletSession.getAttribute("primaryLanguageID", PortletSession.APPLICATION_SCOPE);
			secondaryLanguageID = (long)portletSession.getAttribute("secondaryLanguageID", PortletSession.APPLICATION_SCOPE);
			tertiaryLanguageID = (long)portletSession.getAttribute("tertiaryLanguageID", PortletSession.APPLICATION_SCOPE);
		}catch(Exception e){
