				...
				<table class="table table-sm">
					...
					<tbody>
						<tr class="row-color-blue">
							...
							<td class="align-center">Jul 1, 2019 - Aug 2, 2019</td>
							<td class="align-center"><img src="/o/ahea-theme/images/svg/Project-Type-Lightbulb-Blue-Icon-1.svg" width="44" alt=""></td>
							<td class="align-center">
								<span class="wrap-image">
									<img src="/o/ahea-theme/images/imag-organ-1.jpg" alt="">
									<span class="user-active"></span>
								</span>
								<div class="org-name">Clinton Harris</div>
							</td>
							<td class="align-center">
							...
							<td class="align-center"><img src="/o/ahea-theme/images/imag-status-1.jpg" alt=""></td>
						</tr>
						<tr class="row-color-green">
							<td>REDUCTION IN EPIDURAL PUNCTURE</td>
							<td class="align-center">Sep 3, 2018 - Aug 30, 2019</td>
							...
							<td class="align-center"><img src="/o/ahea-theme/images/imag-status-2.jpg" alt=""></td>
						</tr>
						<tr class="row-color-orange">
							<td>ETHICS IN PATIENT CARE</td>
							<td class="align-center">Dec 10, 2018 - Jul 26, 2019</td>
							<td class="align-center"><img src="/o/ahea-theme/images/svg/Type-Class-Orange-Icon-1.svg" width="44" alt=""></td>
							<td class="align-center">
								<span class="wrap-image">
									<img src="/o/ahea-theme/images/imag-organ-3.jpg" alt="">
									<span class="user-active"></span>
								</span>
							</td>
